...
| `update/update` | `phi update` | `update_data` | Runtime migrated | Uses original update template with progress timeline, RKS graph, Notes/data delta, and optional task/first-record rows. |
