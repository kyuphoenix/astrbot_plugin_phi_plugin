...
def handle(ctx: CommandContext, user_id: str, args: str) -> CommandResult:
    ...
    return CommandResult.text(render.render_records(f"1 Good Top {limit}", records, official_rks=snapshot.ranking_score, average_rks=compute_average_rks(records)))
